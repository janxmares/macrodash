...
tryCatch({download.file(morat_file_cnb_link, here(morat_file_name), mode='wb')
          ...
          loans_hh <- read_excel(morat_file_name, sheet = 'Moratorium_podily', range="B5:B5", col_names = 'loans_hh')
          loans_nfi <- read_excel(morat_file_name, sheet = 'Moratorium_podily', range="C5:C5", col_names = 'loans_nfi')
