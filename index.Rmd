...
# define request
core_infl_req <- request(paste0("https://www.cnb.cz/aradb/api/v1/data?indicator_id_list=SCPIMZM09YOYPECNA&months_before=12&decimal_separator=point&decimals=2&delimiter=comma&api_key=", Sys.getenv('cnb_api_key')))
